...
namespace ECommerenceAPI.Persistance.Migrations
{
    ...
    [Migration("20230402123739_mig_14")]
    partial class mig14
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerenceAPI.Domain.Entities.File", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ECommerenceAPI.Domain.Entities.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("ECommerenceAPI.Domain.Entities.InvoiceFile", b =>
                {
                    b.HasBaseType("ECommerenceAPI.Domain.Entities.File");
            ...
            modelBuilder.Entity("ECommerenceAPI.Domain.Entities.ProductImageFile", b =>
                {
                    b.HasBaseType("ECommerenceAPI.Domain.Entities.File");
            ...
            modelBuilder.Entity("ECommerenceAPI.Domain.Entities.Order", b =>
                {
                    b.HasOne("ECommerenceAPI.Domain.Entities.Basket", "Basket")
                        .WithOne("Order")
                        .HasForeignKey("ECommerenceAPI.Domain.Entities.Order", "BasketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerenceAPI.Domain.Entities.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ECommerenceAPI.Domain.Entities.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.HasOne("ECommerenceAPI.Domain.Entities.Order", null)
                        .WithMany()
                        .HasForeignKey("OrdersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerenceAPI.Domain.Entities.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductProductImageFile", b =>
                {
                    b.HasOne("ECommerenceAPI.Domain.Entities.ProductImageFile", null)
                        .WithMany()
